        ...
        >
          ...
          <Stepper activeStep={activeStep} orientation="vertical">
            ...
            <Step>
              ...
              <StepContent>
                ...
                >
                  <Typography>
                    If there are any key tags you would like to include with
                    your profile, please list them below. Otherwise, you can go
          ...
          {activeStep === 3 && !credentials.errors ? (
            <Alert severity="success">
              ...
              You can now go ahead and <Link href="/login">log in</Link> with
